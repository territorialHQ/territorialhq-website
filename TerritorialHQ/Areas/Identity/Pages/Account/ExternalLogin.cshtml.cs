...
namespace TerritorialHQ.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            var externalLoginResult = await _signInManager.ExternalLoginSignInAsync(info.LoginProvider, info.ProviderKey, isPersistent: true, bypassTwoFactor: true);
            ...
            {
                // If the user does not have an account, then create an account using his Discord ID. Since Discord is the only sigin option,
                // set the email to be a dummy address and confirm it immediately.
